...
Preserve the user's writing style where appropriate.
`;
  }
...
function friendlyError(
  ...
  if (
    ...
    return "Atharv could not connect to an external service. Please try again.";
  }
...
/*
  IMPORTANT:
  Frontend catch-all remains LAST.
*/
